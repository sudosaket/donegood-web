defmodule DonegoodWeb.UserControllerTest do
  use DonegoodWeb.ConnCase

  alias Donegood.Accounts

  @create_attrs %{email: "some email", facebook_id: "some facebook_id", facebook_token: "some facebook_token", google_id: "some google_id", google_token: "some google_token", name: "some name", twitter_id: "some twitter_id"}
